...
open class NewTaskDialog(context: Context, val callback: (String, String) -> Unit) :
    AlertDialog(context) {
    override fun show() {
        super.show()
    ...
    private fun isValid(title: String, description: String) =
        title.isNotEmpty() and description.isNotEmpty()
}